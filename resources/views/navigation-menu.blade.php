...
">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <img src="{{ url('img/logo.png') }}" style="margin-top: 10px;    filter: brightness(1.5);" />
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- <x-jet-nav-link href="{{ route('empresas') }}" :active="request()->routeIs('empresas')" style="color: white;">
                        {{ __('Empresas') }}
                    </x-jet-nav-link> -->
                        ...
                        <x-jet-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                <button class="flex items-center  font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                    <div style="color:white">Empresas</div>
                            ...
                            <x-slot name="content">
                                ...
                                <x-jet-dropdown-link href="{{ route('empresas.create') }}" :active="request()->routeIs('empresas')">
                                    {{ __('Crear Empresa') }}
                                </x-jet-dropdown-link>
                                <x-jet-dropdown-link href="{{ route('empresas') }}" :active="request()->routeIs('empresas')">
